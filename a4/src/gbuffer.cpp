...
void GBuffer::DrawGBuffers( GLFWwindow *window, vec3 fontColour )

{
  ...
  for (int r=0; r<dim; r++)
	...
	drawStrokeString( string(buffer), c/(float)dim*2-0.95, (dim-r-1)/(float)dim*2-0.95, 0.03, 0.0, fontColour );
